package com.inf1nlty.extendedcraft.client.gui;

import com.inf1nlty.extendedcraft.inventory.ContainerSteelLocker;
import net.minecraft.src.*;
import org.lwjgl.opengl.GL11;

public class GuiLocker extends GuiContainer {

    private static final ResourceLocation TEX = new ResourceLocation("extendedcraft:textures/gui/steel_locker_gui.png");
