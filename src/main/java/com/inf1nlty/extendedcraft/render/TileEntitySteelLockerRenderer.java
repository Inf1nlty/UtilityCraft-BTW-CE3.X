package com.inf1nlty.extendedcraft.render;
...
public class TileEntitySteelLockerRenderer extends TileEntitySpecialRenderer {
    private static final ResourceLocation RES_TRAPPED = new ResourceLocation("extendedcraft:textures/blocks/lockerSteel.png");
    private static final ResourceLocation RES_NORMAL = new ResourceLocation("extendedcraft:textures/blocks/lockerSteel.png");
