...
import com.inf1nlty.moreblocks.material.ColoredCementMaterial;
...
public class BlockColoredCement extends BlockContainer {
    ...
    public void registerIcons(IconRegister reg){
        ...
        for(int i=0;i<16;i++){
            wetIcons[i]=reg.registerIcon("moreblocks:"+COLOR_NAMES[i]+"_cement");
            dryingIcons[i]=reg.registerIcon("moreblocks:"+COLOR_NAMES[i]+"_concrete_powder");
        }
    }
