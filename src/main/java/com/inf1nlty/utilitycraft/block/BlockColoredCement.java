...
import com.inf1nlty.utilitycraft.material.ColoredCementMaterial;
...
public class BlockColoredCement extends BlockContainer {
    ...
    public void registerIcons(IconRegister reg){
        ...
        for(int i=0;i<16;i++){
            wetIcons[i]=reg.registerIcon("utilitycraft:cement/" + COLOR_NAMES[i] + "_cement");
            dryingIcons[i]=reg.registerIcon("utilitycraft:concrete_powder/" + COLOR_NAMES[i] + "_concrete_powder");
        }
    }
