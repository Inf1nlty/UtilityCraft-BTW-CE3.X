...
public class UCEmiRecipe {
    ...
    public static EmiWorldInteractionRecipe makeBucketPourRecipe(Item bucketItem, Item cementBlockItem) {
        ...
        Function<SlotWidget, SlotWidget> cementOutputTooltip = slot -> slot.appendTooltip(Text.translatable("emi.colored_cement_bucket.color.tooltip"));
        ...
        ResourceLocation id = new ResourceLocation("utilitycraft", "colored_cement_bucket_pour");
        ...
        return EmiWorldInteractionRecipe.builder()
                ...
                .output(cementStack,cementOutputTooltip)
    ...
    public static EmiWorldInteractionRecipe makeCementAgingRecipe(Item cementBlockItem, Item concreteItem) {
        ...
        ResourceLocation id = new ResourceLocation("utilitycraft", "colored_cement_aging");
