...
import com.inf1nlty.utilitycraft.network.CtrlPlacementTracker;
 ...
 */
public class ItemColoredCementBucket extends UCItem {
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        ...
        if (!world.isRemote) {
            ...
            if (!ctrl && stack.hasTagCompound() && stack.getTagCompound().getBoolean("UC_Ctrl")) {
                ctrl = true;
                stack.getTagCompound().removeTag("UC_Ctrl");
            }
        }
    ...
    private void placeBucketBlock(World world, EntityPlayer player, ItemStack stack, int color) {
        ...
        UCBlocks.coloredCementBucketBlock.placeColoredBucket(world, x, y, z, color, 0);
    ...
    private void pourCement(World world, EntityPlayer player, ItemStack stack, int color) {
        ...
        if (world.isAirBlock(x, y, z) || !world.getBlockMaterial(x, y, z).isSolid()) {
            ...
            world.setBlockAndMetadataWithNotify(x, y, z, UCBlocks.coloredCement.blockID, color);
            world.scheduleBlockUpdate(x, y, z, UCBlocks.coloredCement.blockID, UCBlocks.coloredCement.tickRate(world));
